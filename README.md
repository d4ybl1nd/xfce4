...
This might work only if you use centos7 + xfce4 but i haven't met anyone who uses those stack. just in case if you do, you might need to fiddle with display setting. that woudl be all. So lets leave it there. This xfce4 config is for dual screen. Display config isn't hassle to fiddle with so should be rather straight forward.
